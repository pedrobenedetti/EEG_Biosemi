...
dialogue_rect = dialogue.get_rect(center = (X//2,Y//2-line*2))
...
dialogue2 = dialogue_font.render("Presioná -> cada vez que veas una bola roja.", True, (0,0,0))
dialogue_rect2 = dialogue2.get_rect(center = (X//2,Y//2+line))
dialogue3 = dialogue_font.render("Presioná -> para continuar. Q para salir.", True, (0,0,0))
dialogue_rect3 = dialogue2.get_rect(center = (X//2,Y//2+line*3))

window.blit(dialogue, dialogue_rect)
window.blit(dialogue1, dialogue_rect1)
window.blit(dialogue2, dialogue_rect2)
window.blit(dialogue3, dialogue_rect3)
